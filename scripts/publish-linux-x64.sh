#!/bin/bash
# Publish self-contained executable for Linux x64
...
OUTPUT_PATH="$SCRIPT_DIR/../publish/linux-x64"

echo -e "\033[36mPublishing Outline.Mcp.Server for Linux x64 (self-contained)...\033[0m"
...
if [ $? -eq 0 ]; then
    ...
    echo -e "\033[37m    ./publish/linux-x64/Outline.Mcp.Server\033[0m"
else
